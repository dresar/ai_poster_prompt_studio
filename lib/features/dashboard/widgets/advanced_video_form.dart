...
class _AdvancedVideoFormState extends State<AdvancedVideoForm> {
  ...
  void _submit() {
    widget.onGenerate({
      ...
      'style': _gaya,
      'stylePrompt': _gaya,
      'characterFocus': _selectedCharIds.isNotEmpty ? _selectedCharIds.join(', ') : 'random',
      'characterPrompt': _selectedCharIds.isNotEmpty ? 'Karakter Pilihan: ${_selectedCharIds.join(", ")}' : '',
      'cameraStyle': _kamera,
