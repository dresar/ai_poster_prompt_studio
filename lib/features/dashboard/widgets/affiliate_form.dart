        ...
        NeoSectionCard(
          ...
          child: Column(
            children: [
              ...
              NeoTextField(
                key: const ValueKey('affiliate_hook'),
                label: 'Hook / Kalimat Pemikat',
                placeholder: 'mis: Minum air dingin seharian tanpa es batu? (Opsional)',
        ...
        NeoSectionCard(
          ...
          trailing: NeoFullscreenButton(
            onTap: () => NeoTextField.showExpandedModal(
              ...
              label: 'Kode Promo & Link Pembelian',
              placeholder: 'mis: DISKON10 / shopee.co.id/tokokita',
            ),
          ),
          child: NeoTextField(
            label: '',
              ...
              if (_showAdvanced) ...[
                ...
                NeoDropdownField(
                 ...
                 NeoTextField(
                   ...
                   placeholder: 'Contoh: Ambil Promonya Sekarang! / Belanja Sekarang!',
