...
class PosterForm extends StatefulWidget {
  ...
  @override
  State<PosterForm> createState() => _PosterFormState();
}
...
class _PosterFormState extends State<PosterForm> {
  ...
  Widget build(BuildContext context) {
    final styles = widget.dropdownState.groups['gaya_poster'] ?? [];
    final layouts = widget.dropdownState.groups['tata_letak_poster'] ?? [];
    final ratios = widget.dropdownState.groups['rasio_poster'] ?? [];
    final colors = widget.dropdownState.groups['palet_warna_poster'] ?? [];
      ...
      children: [
        ...
        NeoSectionCard(
          ...
          child: Column(
            children: [
              NeoTextField(
                key: const ValueKey('poster_topic'),
                label: 'Topik Poster / Infografis',
                placeholder: 'mis: 5 langkah sukses membangun startup teknologi',
        ...
        NeoSectionCard(
          title: 'Parameter Visual',
          emoji: '⚙️',
          child: Column(
            children: [
              NeoDropdownField(
                label: 'Gaya Desain Poster',
                leadingEmoji: '⭐',
              ...
              if (_showAdvanced) ...[
                ...
                NeoTextField(
                  ...
                  placeholder: 'Contoh: Jangan Lupa Follow! / Tap Link di Bio',
